<?php exit;?>a:3:{s:8:"template";a:4:{i:0;s:51:"D:/wamp/www/mall/mobile/themes/tianxin100/goods.dwt";i:1;s:61:"D:/wamp/www/mall/mobile/themes/tianxin100/library/up_menu.lbi";i:2;s:67:"D:/wamp/www/mall/mobile/themes/tianxin100/library/goods_gallery.lbi";i:3;s:62:"D:/wamp/www/mall/mobile/themes/tianxin100/library/comments.lbi";}s:7:"expires";i:1480418910;s:8:"maketime";i:1480415310;}<!DOCTYPE html >
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width">
<title>理肤泉特安洁面乳200ml_眼部护理_护肤_甜心100</title>
        ...
        <div class="header">
          ...
          <div class="h-mid">
            <ul>
			  ...
			  <li><a href="goods_pinglun.php?id=118" class="tab_head" id="goods_ka3" >评价</a></li>
            </ul>
          </div>
          <div class="h-right">
            <aside class="top_bar">
       	...
       	<script type="text/javascript" src="themes/tianxin100/js/mobile.js" ></script>
<div class="goods_nav hid" id="menu">
     ...
     <form action="share_goods.php" method="post" id="share_form">
            <input type="hidden" name="content" value="理肤泉特安洁面乳200ml">
            <input type="hidden" name="pics" value="images/201311/goods_img/118_G_1385664875857.jpg">
            <input type="hidden" name="gid" value="118">
            <input type="hidden" name="url" value="http://www.mall.com/mobile/goods.php?id=118">
     </form>
  ...
  <div id="slider" class="slider" style="overflow: hidden; visibility: visible; list-style: none; position: relative;">
    <ul id="sliderlist" class="sliderlist" style="position: relative; overflow: hidden; transition: left 600ms ease; -webkit-transition: left 600ms ease; width: 2400px; left: -600px;">
             <li style="float: left; display: block; width: 600px;"><span><a  href="javacript:void(0)"><img title="" width="100%" src="http://www.mall.com/images/201311/thumb_img/118_thumb_P_1385664875361.jpg"></a></span></li>
           </ul>
    <div id="pagenavi">
...
var t2=new TouchSlider({id:'sliderlist', speed:600, timeout:6000, before:function(index){
		...
		as[active].className='active';
          ...
          <form action="javascript:addToCart(118)" method="post" id="purchase_form" name="ECS_FORMBUY" >
            <div class="product_info">
              <div class="info_dottm">
                <h3 class="name">理肤泉特安洁面乳200ml</h3>
              ...
              <dt> <span id="ECS_GOODS_AMOUNT">￥<span>119</span></span><font>价格：142.80</font>                                  <p>购买此商品赠送119积分</p>
                                  </dt>
                            </dl>
 ...
 <section id="search_ka" class="huodong">
   ...
   <ul class="youhui_list1">
               ...
               <ul class="youhui_list1" style="margin-top:0px;"> 
                          <li><img src="themes/tianxin100/images/hui.png">购买此商品赠送： 119积分</li> 
	...
	<li style=" border-bottom:1px solid #eeeeee">
        <div class="item1">
         ...
         <span class="ui-number">
          ...
          <input type="text" class="num" id="number" onblur="changePrice();" name="number" value="1" min="1" max="65534"/>
...
<div class="subNavBox" > 
    ...
    <li  class="user_price">			
         ...
         <b class="p-price-v">￥<span>119</span></b>
         </p>
             <p>
         <span class="key">vip：</span>
         <b class="p-price-v">￥<span>113</span></b>
         </p>
             <p>
...
554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:118;}554fcae493e564ee0dc75bdf2ebf94ca</div> 
        <script language="javascript"> ShowMyComments(118,0,1);</script>
      </div>
...
<div class="footer_nav">
 ...
 <li><a href="javascript:collect(118)" id="favorite_add"><em class="goods_nav3"></em><span>收藏</span></a></li>
 </ul>
 <dl>
 <dd class="flow"><a class="button active_button" href="javascript:addToCart(118);">加入购物车</a> </dd>
 <dd class="goumai"><a style="display:block;" href="javascript:addToCart1(118)">立即购买</a> </dd>
 </dl>                
</div>                
<script type="text/javascript">
var goods_id = 118;
...
<script>
  wx.config({
    ...
    timestamp: 1480415311,
    nonceStr: 'TzPhSqIMyWLbKoEy',
    signature: '613b6e2e2dae7ca2e373c2ddb74fd7887c8e3c21',
    jsApiList: [
        'onMenuShareTimeline',
 ...
 wx.ready(function () {
    ...
    wx.onMenuShareAppMessage({
      ...
      desc: '理肤泉特安洁面乳200ml',
      link: '',
      imgUrl: 'http://www.mall.com/images/201311/source_img/118_G_1385664875300.png',
