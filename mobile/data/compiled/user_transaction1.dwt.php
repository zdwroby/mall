      ...
      <section class="order_box padd1 radius10" style="padding-top:0;padding-bottom:0;">
          <div class="table_box table_box2">
		   <dl>
            ...
            <dl>
              ...
              <input name="real_name" type="text" placeholder="输入真实姓名如：如:甜心100"  class="dd2">
            </dl>
             <dl>
              <dd class="dd1">开户行 </dd>
        ...
        <div class="blank3"></div>
         <div class="dd_btn">
              ...
              <input type="submit" name="submit"  class="c-btn"  value="<?php echo $this->_var['lang']['submit_request']; ?>"  style="border:none; margin-right:10px; width:40%; float:left;height: 40px" />
              <input type="reset" name="reset" class="c-btn" value="<?php echo $this->_var['lang']['button_reset']; ?>"  style="border:none; margin-right:10px; width:40%; background:#096; float:left;height: 40px"/>
        </div>
