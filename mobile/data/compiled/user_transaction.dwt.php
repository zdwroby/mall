...
?>
    ...
    <?php endif; ?> 
      ...
      <?php if ($this->_var['action'] == 'tuiguang'): ?> 
      <header id="header">
      <div class="header_l header_return"> <a class="ico_10" href="distribute.php"> 返回 </a> </div>
      <h1> 推广二维码</h1>
    </header>
   <div class="blank3"></div>
    <section class="wrap">
          <div class="table_box table_box2" >
          <?php if (! empty ( $this->_var['tuiguang'] [ 'qr_path' ] )): ?>
         <img src="<?php echo $this->_var['_SERVER']['HTTP_HOST']; ?>/wechat/qrcode/<?php echo $this->_var['tuiguang']['qr_path']; ?>" style="width:100%;height:auto" >
         <?php else: ?>
          <dl>
              <dd class="dd1">请到自定义菜单里点击生成 </dd>
...
?>
    ...
    <form name="formSurplus" method="post" action="user.php"> 
      <section class="order_box padd1 radius10" style="padding-top:0;padding-bottom:0;">
          <div class="table_box table_box2">
            <dl>
                <dd class="dd1">申请退款的订单</dd>
          <dd>
            <!--<td><img src="$config['site_url'].$img" width="50" height="50"/></td><br>-->
            <td>订单编号：<?php echo $this->_var['orders']['order_sn']; ?><br> 订单金额：<?php echo $this->_var['orders']['money_paid']; ?></td>
            <td style="position:relative"><span class="new-arr"></span></td>
        </dd>     
            </dl>
             <!-- <dl>
              <dd class="dd1">开户银行 </dd>
              <input name="bank_name" type="text" placeholder="输入退款的银行名称" class="dd2">
            </dl>  
             <dl>
              <dd class="dd1">银行账号 </dd>
              <input name="bank_account" type="text" placeholder="输入退款的银行账号" class="dd2">
            </dl> -->
      <dl>
              <dd class="dd1">退款理由 </dd>
              <textarea placeholder="输入退款理由" name="back_reason" class="B_blue" style="width:100%; height:70px; border:0px; font-size:1em;"></textarea>
            </dl> 
      </div>
        </section>
        <div class="blank3"></div>
         <div class="dd_btn">
              <input type="hidden" name="act" value="do_back">
              <input type="hidden" name="order_id" value="<?php echo $this->_var['orders']['order_id']; ?>">
...
<footer>  <?php echo $this->fetch('library/footer_nav.lbi'); ?> </footer> </div>
</div>
