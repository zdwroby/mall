...
<meta charset="utf-8" />
<title><?php echo $this->_var['page_title']; ?> 商品分类</title>
...
?>
    ...
    <li class="crow level1">
      <div class="crow_row">
        ...
        <div class="crow_title"> <?php if ($this->_var['cat']['id']): ?> <span><?php echo htmlspecialchars($this->_var['cat']['name']); ?></span> <?php else: ?> <span><a href="<?php echo $this->_var['cat']['url']; ?>"><?php echo htmlspecialchars($this->_var['cat']['name']); ?></a></span> <?php endif; ?> </div>
        <!-- roby 11-29此处屏蔽右侧图标，同时需要去掉点击打开子分类内容  <div class="crow_arrow"> <img src="<?php echo $this->_var['ectouch_themes']; ?>/images/ico_11.png"> </div> -->
        <div>&nbsp;</div>
      </div>
    </li>
    </a>
