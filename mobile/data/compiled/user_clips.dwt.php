...
<script type="text/javascript" src="themes/tianxin100/js/12.js"></script>
	...
	<div class="person_top">
			...
			<div class="icon_list">
				<ul>
					...
					<li><a href="user.php?act=point"><img src="themes/tianxin100/images/icon2.png" /><span>积分<?php echo $this->_var['info']['integral']; ?></span></a></li>
...
<section class="wrap">
	<!--
		...
		<div class="per_icon_list">
			<a class="per_list" href="distribute.php">
				<img src="themes/tianxin100/images/icon11.png" class="icon"/>
				<span>分销中心</span>
    ...
    -->
		...
		<div class="per_icon_list">
		  <a  href="tel:<?php echo $this->_var['service_phone']; ?>"
			<a class="per_list">
				<img src="themes/tianxin100/images/icon22.png" class="icon"/>
				<span>呼叫客服</span>
				<img src="themes/tianxin100/images/right.png" class="right_img"/>
			</a>
			</a>
			<a class="per_list" href="user.php?act=profile">
				<img src="themes/tianxin100/images/icon33.png" class="icon"/>
				<span>用户信息</span>
				<img src="themes/tianxin100/images/right.png" class="right_img"/>
			</a>
			<a class="per_list" href="user.php?act=order_list">
				<img src="themes/tianxin100/images/icon44.png" class="icon"/>
				<span>我的订单</span>
				<img src="themes/tianxin100/images/right.png" class="right_img"/>
			</a>
			<a class="per_list" href="user.php?act=address_list">
				<img src="themes/tianxin100/images/icon55.png" class="icon"/>
				<span>收货地址</span>
				<img src="themes/tianxin100/images/right.png" class="right_img"/>
			</a>
		</div>
		<div class="per_icon_list">
			<a class="per_list" href="user.php?act=message_list">
				<img src="themes/tianxin100/images/icon66.png" class="icon"/>
				<span>我的留言</span>
				<img src="themes/tianxin100/images/right.png" class="right_img"/>
			</a>
			<a class="per_list" href="user.php?act=comment_list" >
				<img src="themes/tianxin100/images/icon77.png" class="icon"/>
				<span>我的评论</span>
				<img src="themes/tianxin100/images/right.png" class="right_img"/>
			</a>
		</div>
		<div class="per_icon_list" >
			<a class="per_list" href="user.php?act=logout">
				<img src="themes/tianxin100/images/icon88.png" class="icon"/>
				<span>退出登录</span>
				<img src="themes/tianxin100/images/right.png" class="right_img"/>
			</a>
		</div>
...
<section class="wrap message_list">
  ...
  <form action="user.php" method="post" enctype="multipart/form-data" name="formMsg" onSubmit="return submitMsg()">
    <table width="100%" border="0" cellpadding="5" cellspacing="0" class="ectouch_table">
      ...
      <tr>
        <td> <?php echo $this->_var['lang']['order_number']; ?> <a href ="<?php echo $this->_var['order_info']['url']; ?>"><img src="themes/tianxin100/images/note.gif" /><?php echo $this->_var['order_info']['order_sn']; ?></a>
