...
if ($_REQUEST['act'] == 'backup')
{
	...
	$tables1 = $db->GetCol("SHOW TABLES LIKE '" . mysql_like_quote(wxch_) . "%'");
...
if ($_REQUEST['act'] == 'dumpsql')
{
    ...
    switch ($type)
    {
        case 'full':
            ...
            $temp = $db->GetCol("SHOW TABLES LIKE '%'");
