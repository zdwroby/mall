...
elseif ($_REQUEST['act'] == 'add')
{
    ...
    $smarty->assign('posit_arr',   array('position_style' => '<div id="focus" class="focus region"><div class="bd"><div class="tempWrap" style="overflow:hidden; position:relative;"><ul>{foreach from=$ads item=ad}<li>{$ad}</li>{/foreach}</ul></div></div></div>'));
