...
elseif ($_REQUEST['act'] == 'remove_parent')
{
	...
	/*甜心100 修复脱离上下级关系*/
	$sql ="UPDATE ". $ecs->table('users') ." SET sales1_id = '',sales2_id = '',sales3_id='',sales4_id='',sales5_id='',sales6_id='',sales7_id='',sales8_id='' ,sales9_id=''    WHERE `user_id` = '".$_GET['id']."';";
	$db -> query($sql);
	/*甜心100 修复脱离上下级关系*/
    ...
    for ($i = 1; $i<=$num; $i++)
    {
        ...
        if ($count)
        {
			...
			foreach($user_info as $key=>$value){
				...
				$user_info[$key]['reg_time'] = local_date($GLOBALS['_CFG']['date_format'], $user_list[$key]['reg_time']);
			}
