...
$_LANG['password_set'] = '设置提现密码';
$_LANG['password_first'] = '请输入密码';
$_LANG['password_second'] = '请核实密码';
$_LANG['password_second_lang'] = '请再次输入密码';
$_LANG['sign_up'] = '注册新会员';
...
$_LANG['account_log'] = '账户记录';
$_LANG['account_raply'] = '提现申请';
$_LANG['account_deposit'] = '账户充值';
$_LANG['account_num'] = '可提余额';
$_LANG['limit_account_replay'] = '提现额度';
$_LANG['account_raply_num'] = '提现金额';
$_LANG['account_raply_num_lang'] = '输入提现金额';
$_LANG['account_raply_num_check'] = '提现密码验证';
$_LANG['account_raply_num_pass'] = '请输入提现密码';
